...
sudo pip install django uwsgi pillow boto mysql-python djangorestframework drf-extensions django-cors-headers django-rest-swagger python-logstash django-haystack django-pagination lxml requests BeautifulSoup elasticsearch newrelic django-grappelli python-social-auth
